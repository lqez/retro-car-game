...
export const ENEMY_FLOW_MAX_TILES = 32;          // BFS path-distance cap for the chase flow field
export const ENEMY_CHASE_KEEP_MUL = 1.25;        // hysteresis: keep chasing out to DETECT_DIST × this
export const ENEMY_TERRITORY_SLACK = 3;          // extra tiles past territory before abandoning a chase
